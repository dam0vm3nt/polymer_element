define(['dart_sdk',
          './native_import', 'exports','polymerize_require/htmlimport!bower_components/polymer/polymer.html','polymerize_require/htmlimport!bower_components/polymer/lib/mixins/mutable-data.html'
    ],
    function (sdk,  native_import, exports) {
        ...
        exports.polymerize_js = {
          initModule() {
              console.log('polymerize loaded!');
          }
        };
